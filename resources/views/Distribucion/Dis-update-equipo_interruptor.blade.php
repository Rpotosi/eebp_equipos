...
@section('title', 'Mantenimiento Equipos Dis')
...
@section('content')
    ...
    <div class="form-container">
        <form id="formulario" class="row g-3">
            ...
            <form id="formulario" class="row g-3" method="POST" action="{{ route('distribucion.store_mantenimiento_equipo_interruptor', ['id_equipo' => $equipo->id_equipo]) }}" enctype="multipart/form-data">
                @csrf
